...
Internal custody accounts can still sit beneath a program's staking group. Principal moves between actual leaves, with pending entitlement following the movement. Available rewards stay on the economic leaf where they vested and can be claimed through an authorized explicit-account consumer. This account nesting does not create another SR program.
