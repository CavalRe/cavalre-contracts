...
//     // Selectors
//     bytes4 internal constant CLONE = bytes4(keccak256("clone(string,string,uint8,uint256)"));
...
//         _commands[10] = ERC20Lib.INCREASE_ALLOWANCE;
//         _commands[11] = ERC20Lib.DECREASE_ALLOWANCE;
//     }
...
//     ) public {
//         emit log("Initializing");
//         emit log_named_address("owner", ML.owner());
//         emit log_named_address("sender", msg.sender);
//         // ML.enforceIsOwner();
//         // emit log("Enforced owner");
//         Store storage s = ERC20Lib.store();
//         emit log("Got store");
//         if (s.isInitialized) {
//             revert("ERC20: Already initialized");
//         }
//         emit log("Not initialized");
//         ML.store().owner = msg.sender;
//         emit log("Set owner");
//         s.name = _name;
//         emit log("Set name");
...
//         emit log("Set decimals");
//         s.totalSupply = _totalSupply;
//         emit log("Set totalSupply");
//         s.balances[msg.sender] = _totalSupply;
//         emit log("Set balance");
//         s.isInitialized = true;
//         emit log("Set initialized");
//     }
...
//         emit log("Cloning");
//         instance = Clones.clone(ML.implementation());
//         emit log_named_address("instance", instance);
//         (bool success, ) = instance.call(
//             abi.encodeWithSignature("initialize(string,string,uint8,uint256)", _name, _symbol, _decimals, _totalSupply)
//         );
//         require(success, "ERC20: Clone failed");
//     }
